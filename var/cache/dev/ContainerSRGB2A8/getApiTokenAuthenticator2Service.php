 ...
 */
class getApiTokenAuthenticator2Service extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'debug.App\Security\ApiTokenAuthenticator' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['debug.App\\Security\\ApiTokenAuthenticator'])) {
            return $container->privates['debug.App\\Security\\ApiTokenAuthenticator'];
        }

        return $container->privates['debug.App\\Security\\ApiTokenAuthenticator'] = new \Symfony\Component\Security\Http\Authenticator\Debug\TraceableAuthenticator($a);
    }
}
