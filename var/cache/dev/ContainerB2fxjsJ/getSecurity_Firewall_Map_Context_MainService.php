...
class getSecurity_Firewall_Map_Context_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 3), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, ($container->privates['security.authentication.trust_resolver'] ??= new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver()), $c, 'main', $a, NULL, NULL, ($container->privates['logger'] ?? self::getLoggerService($container)), true), new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $c, ($container->privates['debug.security.event_dispatcher.main'] ?? $container->load('getDebug_Security_EventDispatcher_MainService')), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'app_logout']), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', NULL, true, true, 'App\\Security\\UserProvider', NULL, 'App\\Security\\ApiTokenAuthenticator', NULL, NULL, ['remember_me', 'App\\Security\\ApiTokenAuthenticator', 'App\\Security\\GoogleAuthenticator'], NULL, ['path' => 'app_logout', 'target' => 'app_login', 'enable_csrf' => NULL, 'csrf_token_id' => 'logout', 'csrf_parameter' => '_csrf_token', 'invalidate_session' => true, 'clear_site_data' => [], 'delete_cookies' => []]));
    }
}
